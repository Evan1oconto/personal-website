                            ...
                            <div className="col-md-6 col-lg-6 pl-md-5 py-5">
                                <div className="row justify-content-start pb-3">
                                    <div className="col-md-12 heading-section">
                                        ...
                                        <p>I am a sophmore at Tufts University that is interested in computer science. I enjoy watching and playing sports, learning about the stock market, and rock climbing</p>
                                        <ul className="about-info mt-4 px-md-0 px-2">
                                            <li className="d-flex"><span>Name:</span> <span>Evan L</span></li>
                                            <li className="d-flex"><span>Address:</span> <span>Amherst NH</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
